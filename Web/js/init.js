...
function initLogin() {
    ...
    //    method: 'GET',
    //    url: '/admin/ashx/bg_menu.ashx?action=getUserMenu',
    //    lines: true,
    ...
    //});
    $.ajax({
        url: "/admin/ashx/bg_user_login.ashx",
        type: "post",
        data: { action: "getuser" },
        dataType: "json",
            ...
            if (result.success) {
                ...
                if (!result.msg.IfChangePwd) {    //如果是首次登陆必须重置密码
                    $("<div/>").dialog({
                        ...
                        href: "/admin/html/ui_user_firstlogin.html",
                        title: "首次登陆需重置密码",
                        height: 160,
                        width: 360,
                        modal: true,
...
function searchMyInfo() {
    $("<div/>").dialog({
        id: "ui_myinfo_dialog",
        href: "/admin/html/ui_myinfo.html",
        title: "我的信息",
        height: 500,
        width: 580,
        modal: true,
        onLoad: function () {
            $.ajax({
                url: "/admin/ashx/bg_user.ashx?action=getUserInfo&timespan=" + new Date().getTime(),
                type: "post",
                dataType: "json",
                success: function (result) {
            ...
            $('#ui_myinfo_authority').tree({
                url: "/admin/ashx/bg_menu.ashx?action=getMyAuthority&timespan=" + new Date().getTime(),
                onlyLeafCheck: true,
                checkbox: true
            });
        },
...
function changePwd() {
    $("<div/>").dialog({
        ...
        href: "/admin/html/ui_user_changepwd.html",
        title: "修改密码",
        height: 240,
        width: 380,
        modal: true,
