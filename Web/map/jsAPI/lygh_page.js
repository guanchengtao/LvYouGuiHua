    ...
    function paginationNick(opt) {
        ...
        //将展示的数据赋值给pager.data  (array)
                $.getJSON("../Admin/ashx/LvYouGuiHuaList.ashx", {}, function (value) {
    ...
    $('.' + pager.btnBox + ' .next-btn').attr('disabled', true);
        ...
        //调用
        paginationNick({
        paginationBox: 'pagination-nick1',//分页容器--必填
            mainBox: 'main-box-nick1',//内容盒子--必填
            numBtnBox: 'num-box-nick1',//数字按钮盒子-- 必填
            btnBox: 'btn-box-nick1',//按钮盒子 --必填
            ipt: 'page-ipt-nick1',//input class-- 必填
            goBtn: 'go-btn-nick1',//go btn class --必填
            currentBtn: 'active-nick1'//当前按钮class name --必填
        });
